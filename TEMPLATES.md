...
[무료 콘텐츠 스토어](CONTENT_STORES.md)에서는 전체 템플릿으로 새 프로젝트를 만드는 동작과 현재 프로젝트에 구성 요소를 추가하는 동작을 구분합니다. 다운로드·검토·적용과 사본 편집·업데이트 정책은 개발 목표이며 현재 데모의 외부 템플릿 지원을 뜻하지 않습니다.
