...
현재 데모에서는 플레이어를 개별적으로 초대하고 캐릭터를 배정해 온라인 플레이를 시험할 수 있습니다. 참가자는 자신에게 배정된 캐릭터만 조작하며, 배정되지 않으면 관전합니다. GM은 캐릭터 배정·개인 공개 정보·NPC 조작을 관리합니다. 기본 롤플레이 채팅을 지원합니다. 여러 개인 파티, 각자 다른 장면에서의 탐험과 통합 로비는 아직 개발 중입니다. [온라인 파티와 캠페인](PARTY_PLAY.md)에서 앞으로의 기능을 소개합니다.
...
**프로젝트 설정 → 온라인·운영**에서 채팅을 켜고 배치와 허용 수신 범위를 정합니다. 대사와 기록 사용법은 [롤플레이 채팅](ROLEPLAY_CHAT.md)을 참고하세요.

{% include screenshot.html file="afd69717b13317f02bc8.png" alt="프로젝트의 온라인 채팅 배치와 정책 설정" caption="채팅 배치와 수신 범위, 대화 저장 정책을 작품별로 정합니다." width="1440" height="960" %}
